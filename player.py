...
class Player(CircleShape):
    ...
    def rotate(self, dt: pygame.time.Clock) -> None:
    ...
    def shoot(self) -> None:
        ...
        initial_velocity: pygame.Vector2 = pygame.Vector2(0, 1)
        rotated_velocity = initial_velocity.rotate(self.rotation)
        scaled_rotated_velocity = rotated_velocity * PLAYER_SHOOT_SPEED
        shot.velocity = scaled_rotated_velocity